...
function BInprogrss() {
  ...
  const BreedStatus = () => {
    ...
    const isBreedFailed =
      breedData?.isPaying && breedData?.isClaim === 1 && breedData?.isDead;
            ...
            <div className="waveWrapper banner  waveAnimation waveprofile">
              <div className="text-center divide-area w-100">
                <div className="info info-breeding">
                  ...
                  {breedData?.isPaying == false &&
                    breedData?.isClaim == 1 &&
                    !breedData?.isDead && (
                      <div
                        className="userImage questionImage"
                    ...
                    !breedData?.isDead && (
                      <>
                        {!isShowAnimi ? (
                          ...
                          <AnimatedCard
                            ref={childRef}
                            imagePath={breedingMetaData?.image}
                          />
                        )}
                      </>
                    )}
                  ...
                  {breedData?.isPaying == true &&
                    ...
                    {/* here add animation when not paying */}
                  {/* {breedData?.isPaying == false &&
                    breedData?.isClaim == 1 &&
                    breedData.isDead && (
                      <div
                  ...
                  {breedData?.isClaim == 1 &&
                    ...
                    !breedData.isDead && (
                      <div className="white-background mt15">
                        ...
                        <CaretDisplay
                          value={breedData?.rarityPoints}
                          className={"right dflex"}
                        />
                      </div>
                    )}
                  {/* {!hasBreedReady && (
