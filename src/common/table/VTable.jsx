...
const Table = ({
  ...
  return (
    <>
      <div className="overflow-x-auto rounded-lg table-content ">
            ...
            <tr>
              {cols.map((col, index) => (
                <th
                  ...
                  className="px-4 py-5 text-left text-sm font-medium text-white uppercase tracking-wider table-th"
          ...
          <tbody className="">
            {isTableLoading ? (
              ...
              sortedData().map((item, rowIndex) => (
                ...
                <tr key={rowIndex} className="hovertr">
                  {cols.map((col, colIndex) => (
                    <td
                      key={colIndex}
                      className="px-4 py-3 text-left text-xs font-medium text-[#ffffffd9] uppercase tracking-wider"
                    >
                      {col.render
      ...
      {isPagination && (
        <Stack spacing={2} direction="row" className="flex justify-between">
